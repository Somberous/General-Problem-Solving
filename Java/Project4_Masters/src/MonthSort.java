...
/*
    ...
    Class:          COP2552
	File Name:      MonthSort.java
	Synopsis:		This class will be responsible for sorting,outputting, and displaying Hurricane Months
*/
...
public class MonthSort {
    ...
    private void displayOutput(String sortType) {
        ...
        JOptionPane.showMessageDialog(null, "Your output file has been created at " + path + "\\SortByMonth.txt",
    ...
    private void writeOutput(JTable table) {
        try {
            PrintWriter p = new PrintWriter(new File(path + "/SortByMonth.txt"));
