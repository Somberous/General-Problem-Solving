/*
    ...
    Class:          COP2552
	File Name:      CategorySort.java
	Synopsis:		This class will be responsible for sorting,outputting, and displaying Hurricanes categories
*/
...
public class CategorySort {
	...
	private void displayOutput(String sortType) {
		...
		JOptionPane.showMessageDialog(null, "Your output file has been created at " + path + "\\SortByCategory.txt",
	...
	private void writeOutput(JTable table) {
		try {
			PrintWriter p = new PrintWriter(new File(path + "/SortByCategory.txt"));
