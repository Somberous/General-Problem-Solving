...
*    Class:          COP2552
*	File Name:      YearSort.java
*	Synopsis:		This class will be responsible for sorting,outputting, and displaying Hurricane Years
*/
...
public class YearSort {
    ...
    private void getSortOrder() {
        ...
        String selection = (String) JOptionPane.showInputDialog(null, "Sort By Hurricane Month\n\n",
    ...
    private void displayOutput(String sortType) {
        ...
        JOptionPane.showMessageDialog(null, "Your output file has been created at " + path + "\\SortByYear.txt",
    ...
    private void setEventListener(JFrame frame) {
        ...
        // I had to visit StackOverflow for the help with this
    ...
    private void writeOutput(JTable table) {
        try {
            PrintWriter p = new PrintWriter(new File(path + "/SortByYear.txt"));
