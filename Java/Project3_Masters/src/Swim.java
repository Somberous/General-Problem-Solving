/*
    ...
    Class:          COP2552
	File Name:      Swim.java
	Synopsis:		Class to handle the swim exercise selection
*/
...
public class Swim {
	...
	private double setTime() {
		...
		while (tempInt <= 0) {
			...
			try {
				...
				tempString = JOptionPane.showInputDialog("How long did you swim for? (Minutes)\n\n");
	...
	public void calculateCalories(int intensityLevel) {
		...
		switch (intensityLevel) {
			...
			case 1:
				calories += 6.8 * tempInt;
				break;

			case 2:
				calories += 14.8 * tempInt;
				break;
	...
	public String getSwimTotals() {

		return "Your total time swimming was " + String.format("%.2f", time) + " minutes"
