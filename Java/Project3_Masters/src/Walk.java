/*
    ...
    Class:          COP2552
	File Name:      Walk.java
	Synopsis:		Class to handle the walking exercise selection
*/
...
public class Walk {
	...
	private double setTime() {
		...
		while (tempInt <= 0) {
			...
			try {
				...
				tempString = JOptionPane.showInputDialog("How long did walk for? (Minutes)\n\n");
	...
	public String getWalkTotals() {

		return "Your total time walking was " + String.format("%.2f", time) + " minutes"
