/*
	...
	Synopsis:		Class to handle the bicycle exercise selection
*/
...
public class Bicycle {
	...
	private double setTime() {
		...
		while (tempInt <= 0) {
			...
			try {
				...
				tempString = JOptionPane.showInputDialog("How long did you ride your bike? (Minutes)\n\n");
	...
	public String getBikeTotals() {

		return "Your total time on the bike was " + String.format("%.2f", time) + " minutes"
